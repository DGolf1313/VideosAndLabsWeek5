...
public class TeamMenuApp {
	...
	private static void describeTeam() {
		printTeamNames();
		System.out.print("Which team would your like to see the info for?");
	...
	private static void removePlayerFromTeam() {
		printTeamNames();
		System.out.print("Enter the name of the team you wish to remove a player to");
		String teamName = scanner.next();
		try {
			Team foundTeam = findTeamByName(teamName);
			foundTeam.describe();
	...
	private static Team createNewTeam() {
		System.out.println("Enter the name of your new team");
		String name = scanner.next();
